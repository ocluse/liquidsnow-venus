...
namespace Ocluse.LiquidSnow.Venus.Razor.TagHelpers
{
    ...
    {
        public SectionHeadingTagHelper(IVenusResolver venusResolver) : base(venusResolver)
        {
        }
        ...
        protected override void BuildClass(List<string> classList)
        {
            ...
            classList.Add(_venusResolver.ResolveTextStyle(TextStyle.Subtitle));
    ...
    {
        public AvatarTagHelper(IVenusResolver venusResolver) : base(venusResolver)
        {
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            string src = string.IsNullOrEmpty(UserId) ? Src : _venusResolver.ResolveAvatarId(UserId);
